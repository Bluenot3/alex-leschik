    ...
    <section className="zen-gen" id="zen-gen" aria-label="ZEN-GEN generative archive">
      ...
      <header className="zen-gen__head">
        ...
        <p className="zen-gen__lede">
          Every image here was made with ZEN-GEN, and the collection keeps growing. Browse it as a grid,
          play it as a slideshow, or view it in 3D.
        </p>

        <div className="zen-gen__stat">
          <span className="zen-gen__stat-n">{String(total).padStart(4, "0")}</span>
          <span className="zen-gen__stat-l">images in the archive</span>
        </div>
      </header>
