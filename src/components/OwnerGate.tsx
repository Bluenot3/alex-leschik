 ...
 *
 * This is a convenience layer, not the security boundary — server-side
 * session verification independently rejects any unsigned cookie,
 * so bypassing this component gains nothing.
 */
    ...
    return (
      <>
        ...
        <div className="owner-gate__bar">
          <span>{footNote ?? "owner session"}</span>
